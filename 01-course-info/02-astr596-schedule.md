...
| 3 | Sept 12 | Intro to Numerical Methods, Statistical Foundations, & <br> Random Sampling | Phase 1 | [Linear Algebra Module 1](../04-mathematical-foundations/00a-linear-algebra-core-module.md);<br> Numerical Methods [Modules 1](../06-numerical-methods/module-1-foundations-of-discrete-computing/) and [Module 3](../06-numerical-methods/module-3-ODE-methods-and-conservation/) |
