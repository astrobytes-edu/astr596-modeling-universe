...
| 3 | Sept 12 | Intro to Numerical Methods, Statistical Foundations, & <br> Random Sampling | Phase 1 | [Linear Algebra Module 1](../04-mathematical-foundations/00a-linear-algebra-core-module.md);<br> Numerical Methods [Modules 1](../06-numerical-methods/module-1-foundations-of-discrete-computing/), [Module 2](../06-numerical-methods/module-2-static-problems-and-quadrature/), and [Module 3](../06-numerical-methods/module-3-ODE-methods-and-conservation/) |
| 4 | Sept 19 | Numerical Methods (cont.), Statistics, <br> N-body dynamics & Conservation Laws, The Virial Theorem | Phase 1 | Statistical Thinking [Module 1](../05-statistical-thinking/module-1-how-nature-computes/), [Module 2](../05-statistical-thinking/module-2-from-particles-to-stars/) & [Module 3](../05-statistical-thinking/module-3-when-stars-become-particles/) |
| 5 | Sept 26 | Radiative Transfer, Numerical Integration, & MC Methods | Phase 1 | TBD |
