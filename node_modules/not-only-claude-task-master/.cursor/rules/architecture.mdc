...
- **Main Modules and Responsibilities**:
  ...
  - **[`ai-services.js`](mdc:scripts/modules/ai-services.js) (Conceptual): AI Integration**
    - **Purpose**: Abstracts interactions with AI models (like OpenRouter and Perplexity AI) for various features.
    - **Responsibilities**:
...
- **Testing Architecture**:
  ...
  - **Mock Integration Patterns**:
    - **External Libraries**: Libraries like `fs`, `commander`, and `@openai/openai` are mocked at module level
