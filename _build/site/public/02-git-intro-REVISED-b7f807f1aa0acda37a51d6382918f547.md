...
```{admonition} 📚 Student Developer Pack Benefits
:class: note
...
```{admonition} 🔐 Required Since August 2021
:class: important
...
```{admonition} 📚 How GitHub Classroom Works
:class: important
...
```{admonition} ⚠️ Critical: Submission = Push
:class: warning
...
```{admonition} 💡 Pro Tip: Push Early and Often
:class: tip
...
```{admonition} 📝 Commit Message Best Practices
:class: tip
